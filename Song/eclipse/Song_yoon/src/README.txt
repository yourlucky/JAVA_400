...
- Did what each other member should do based on trust
-Through discord keep discussing for understanding overall projects
-Through Git keep check other members code status
...
----------------------
@wisc.edu Email: <yna23@wisc.edu>
Files Written By: <SongData.java, SongLoader.java>
Additional Contributions: <upload top10s.csv, Top500Songs.csv, README.txt>
Referenced Works: <none>
Signature: <Yoon Chae Na>
