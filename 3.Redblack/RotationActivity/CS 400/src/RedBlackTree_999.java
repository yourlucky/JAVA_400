 ...
 */
    ...
    @Test
        ...
        assertEquals("Inorder traversal: [7, 14, 18, 23, 1, 11, 20, 29]", tree.toString());
    }
    ...
    public void test2() {
        ...
        assertEquals("Inorder traversal: [1, 2, 3, 4, 5, 6, 7]", tree.toString());
    ...
    public void test3() {
        ...
        assertEquals("Inorder traversal: [a, b, c, d, e, f]", tree.toString());
...
public Iterator<T> iterator() {
     ...
     * @return boolean indicating whether there are more elements / steps for the travers
    al
     */
