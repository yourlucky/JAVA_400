 ...
 * tree.
 */
public class RedBlackTree2<T extends Comparable<T>> implements SortedCollectionInterface<T> {
  ...
  /**
   * Resolve a red child under a red parent red black tree property violations that are introduced
  ...
  private void enforceRBTreePropertiesAfterInsert(Node<T> newNode) {
    ...
    if (uncleNode == null || uncleNode.isBlack) {
      ...
      if ((newNode == parent.rightChild && uncleIsRight)
  ...
  private void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
    if (parent.leftChild == child) {
      ...
      // Connect child.rightNode to parent
      ...
      Node<T> cl = child.leftChild;

      if (cl != null) {
        cl.parent = parent;
      }
      parent.rightChild = cl;
